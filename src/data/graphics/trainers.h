...
const u32 gTrainerFrontPic_JGin[] = INCBIN_U32("graphics/trainers/front_pics/gintest.4bpp.lz");
const u32 gTrainerPalette_JGin[] = INCBIN_U32("graphics/trainers/palettes/gintest.gbapal.lz");